...
//$orgid="urn:uuid:13B0D5BD-B087-3749-BE3D-BE5658FF5FE2";
//$orgcode="TZ.ST.LI.KW.1.1.2";
//$_REQUEST["contact_details"]="add 0683088392 silas";
...
$ch=initialize_curl();
        $url = "http://54.148.103.198:8001/api/v1/contacts.json";
	curl_setopt($ch, CURLOPT_URL,$url);
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS,'{
         ...
         $output = curl_exec ($ch);
	$url = "http://54.148.103.198:8001/api/v1/broadcasts.json";
	curl_setopt($ch, CURLOPT_URL,$url);
